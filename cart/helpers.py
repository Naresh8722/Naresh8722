...
class CartHelper(APIView):
    ...
    def __init__(self, user):
        ...
        self.cart_items = []
        self.discounts = {}
        self.checkout_details = {'products': [], 'total': [], 'amount': [], 'Grand Total Amount':[]}
    ...
    def get_total_amount_after_discounts(self):
        ...
        self.cart_final_total_amount = self.cart_base_total_amount - (self.campaign_discount_amount + self.coupon_discount_amount)
    ...
    def prepare_checkout_details(self):
        ...
        self.checkout_details['Grand Total Amount'].append({'total_amount':self.cart_final_total_amount + self.delivery_cost})